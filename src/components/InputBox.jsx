...
const [input,setInput]=useState("")
  ...
  return (
    <div className='relative mt-4'>
      ...
      <label for={placeholder}  className={(input=="")?" cursor-text transform duration-150 transtion z-10 text-md  peer-focus:scale-75 peer-focus:top-0  absolute top-1/2 left-2 -translate-y-1/2  origin-[0] bg-white":"z-10 text-md scale-75 absolute top-0 left-2 -translate-y-1/2   origin-[0] bg-white"}>{placeholder}</label>
